    ...
    private void initViewDragHelper() {
        dragHelper = ViewDragHelper.create(this, 1f, new ViewDragHelper.Callback() {
            ...
            public void onViewPositionChanged(View changedView, int left, int top, int dx, int dy) {
                ...
                log("===onViewPositionChanged, left:%d, top:%d, dx:%d, dy:%d", left, top, dx, dy);
            }

            @Override
            public void onViewDragStateChanged(int state) {
                super.onViewDragStateChanged(state);
                log("===onViewDragStateChanged, state:%d", state);
            }
            ...
            public int clampViewPositionVertical(View child, int top, int dy) {
                ...
                Log.d(TAG, String.format("===clampViewPositionVertical, top:%d, dy:%d, topBound:%d, bottomBound:%d",
            ...
            public void onViewReleased(View releasedChild, float xvel, float yvel) {
                ...
                log("===onViewReleased, xvel:%f, yvel:%f, childTop:%d, topBound:%d, isDragView:%b",
...
//            ViewCompat.postInvalidateOnAnimation(this);
    ...
    private void log(String tpl, Object... args) {
